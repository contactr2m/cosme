...
from cosme.v1.forms import FilterableListForm
from cosme.v1.models.base import AbstractFilterPage
from cosme.v1.util.ref import get_category_children
...
class FilterableListMixin(object):
    ...
    def get_context(self, request, *args, **kwargs):
        ...
        form = FilterableListForm(form_data, filterable_pages=self.filterable_pages())
