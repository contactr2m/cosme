...
from ..util.email import send_password_reset_email
...
class COSMEPasswordChangeForm(PasswordValidationMixin, PasswordChangeForm):
    pass


class COSMEPasswordResetForm(PasswordValidationMixin, PasswordResetForm):
    pass


class COSMESetPasswordForm(PasswordValidationMixin, SetPasswordForm):
    pass
