...
class COSMEImage(AbstractImage):
    ...
    def get_rendition(self, rendition_filter):
        ...
        COSMEImage overrides the default Wagtail renditions behavior to
        ...
        if self.file.name.endswith('.gif'):
            ...
            return super(COSMEImage, self).get_rendition(rendition_filter)
...
class COSMERendition(AbstractRendition):
    image = models.ForeignKey(COSMEImage, related_name='renditions',
